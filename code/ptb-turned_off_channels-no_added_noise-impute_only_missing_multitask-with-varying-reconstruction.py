...
reconstruction_loss_weights = np.linspace(0,1,10)

for reconstruction_weight in reconstruction_loss_weights:

    
    # Setting reconstruction loss
    # -------------------
    config['seed']=seed
    config['reconstruction_loss_weight']=reconstruction_weight
    ...
    config['model_saving_path']     = f"./combined_downstream_upstream/models/ptb-{config['channels_to_turn_off']}_channels_off-no_additional_noise-impute_only_missing-reconstruction_loss"
    config['plot_saving_path']      = f"/home/david/Desktop/projects/thesis/combined_downstream_upstream/plots/ptb-{config['channels_to_turn_off']}_channels_off-no_additional_noise-impute_only_missing-reconstruction_loss"
    ...
    best_rocauc_and_pr_auc['reconstruction_loss_weight'].append(reconstruction_weight)
