...
for seed_ in seeds:
    ...
    config['model_saving_path']     = f"./combined_downstream_upstream/models/china-{config['channels_to_turn_off']}_channels_off-no_additional_noise-impute_only_missing-unfreeze_upstream_weights"
    config['plot_saving_path']      = f"./combined_downstream_upstream/plots/china-{config['channels_to_turn_off']}_channels_off-no_additional_noise-impute_only_missing-unfreeze_upstream_weights"
