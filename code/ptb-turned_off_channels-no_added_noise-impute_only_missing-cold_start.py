...
for seed_ in seeds:
    ...
    config['model_saving_path']     = f"./combined_downstream_upstream/models/ptb-{config['channels_to_turn_off']}_channels_off-no_additional_noise-impute_only_missing-cold_start"
    config['plot_saving_path']      = f"/home/david/Desktop/projects/thesis/combined_downstream_upstream/plots/ptb-{config['channels_to_turn_off']}_channels_off-no_additional_noise-impute_only_missing-cold_start"
