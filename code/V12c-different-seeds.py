...
for seed_ in seeds:
    ...
    config = {
            ...
            'model_saving_path':'./combined_downstream_upstream/models/AF-V12c-different-seeds',
            
            'plot':True,
            'plot_saving_path':f'/home/david/Desktop/projects/thesis/combined_downstream_upstream/plots/AF-129c-different-seeds',
            # test
            'check_on_test':True,
            }
